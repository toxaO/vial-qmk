...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_universal(
    _______  , KC_F6    , KC_F7    , KC_F8    , KC_F9    , KC_F10  ,                                          XXXXXXX    , KC_7       , KC_8     , KC_9     , KC_0     , KC_BSPC  ,
    _______  , KC_PSCR  , KC_F2    , KC_F3    , KC_F4    , KC_F5   ,                                          KC_DOT     , KC_4       , KC_5     , KC_6     , KC_MINS  , XXXXXXX  ,
    _______  , DM_REC1  , DM_RSTP  , DM_PLY1  , KC_F11   , KC_F12  ,                                          S(KC_SCLN) , KC_1       , KC_2     , KC_3     , KC_SLSH  , XXXXXXX  ,
                  _______  , _______ , _______  ,         _______  , _______  ,                   QK_AREP  , _______  , _______       , _______  , XXXXXXX
  ),
